...
import com.ebf.instant.data.post.FirestorePostDataSource.Companion.COMMENT_CONTENT
import com.ebf.instant.data.post.FirestorePostDataSource.Companion.COMMENT_TIMESTAMP
import com.ebf.instant.data.post.FirestorePostDataSource.Companion.COMMENT_USER
import com.ebf.instant.data.post.FirestorePostDataSource.Companion.LIKE_TIMESTAMP
import com.ebf.instant.data.post.FirestorePostDataSource.Companion.LIKE_USER
import com.ebf.instant.data.post.FirestorePostDataSource.Companion.POST_DESCRIPTION
import com.ebf.instant.data.post.FirestorePostDataSource.Companion.POST_IMAGE_URL
import com.ebf.instant.data.post.FirestorePostDataSource.Companion.POST_TIMESTAMP
import com.ebf.instant.data.post.FirestorePostDataSource.Companion.POST_USER
import com.ebf.instant.data.post.FirestorePostDataSource.Companion.USER_ID
import com.ebf.instant.data.post.FirestorePostDataSource.Companion.USER_IMAGE_URL
import com.ebf.instant.data.post.FirestorePostDataSource.Companion.USER_NAME
import com.ebf.instant.data.post.FirestorePostDataSource.Companion.USER_USERNAME
